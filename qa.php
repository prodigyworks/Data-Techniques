...
<div>
	...
	<?php	
		...
		if ($temp == "TEMP") {
	?>
			<h2>Job <a title="View Job" href="viewquote.php?id=<?php echo $header->headerid; ?>"><?php echo $header->getHeaderID(); ?></a> has been rejected by <i>Quality Assurance</i>.</h2>
	...
	?>
			<h2>Job <a title="View Job" href="viewquote.php?id=<?php echo $header->headerid; ?>"><?php echo $header->getHeaderID(); ?></a> has been passed by <i>Quality Assurance</i>.</h2>
			<h3>Notifications have been sent regarding changes to this job.</h3>
			<a class='backicon' href='index.php' title="Dashboard"></a>
