<?php
	...
	$header->load($_GET['id']);
?>
<h2>Quotation <a title="View Quote" href="viewquote.php?id=<?php echo $header->headerid; ?>"><?php echo $header->prefix . sprintf("%04d", $header->headerid); ?></a> has been cancelled.</h2>
<?php
