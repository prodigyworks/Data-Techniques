	...
	class PDF_Invoice extends FPDF
	{
		...
		*/
		...
		function pageHeader($header) {
			...
			$this->addHeading(10, 48 + $margin, "CPID Number:", $header->cpid);
			$this->addHeading(10, 52 + $margin, "Cost Code:", $header->costcodedesc);
			$this->addHeading(10, 56 + $margin, "Site:", GetSiteName($header->siteid) );
		}
	}
