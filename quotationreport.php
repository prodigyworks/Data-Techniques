<?php
	...
	$pdf->addAddress( "Delivery/Site Address:", GetSiteAddress($header->siteid) , 10, 64);
	                  
	$pdf->addAddress( "",
	                  "Data Techniques House\n" .
	                  "Farnborough Business Centre\n" .
	                  "Eelmoor Rd\nFarnborough \n" .
	                  "Hampshire\n" .
					  "Tel: 01252 375566", 150, 14);
	                  
//	$pdf->addTitle( "QUOTATION");

	$pdf->Image("images/headerlogo.png", 150.6, 1);
	$pdf->Image("images/dtfooter.png", 24, 280);
	
    $pdf->SetXY( 100, 273 );
    $pdf->SetFont('Arial','', 7);
    $pdf->MultiCell(54, 1, "Installing Confidence");
	
    $pdf->SetXY( 80, 275 );
    $pdf->SetFont('Arial','', 6);
    $pdf->MultiCell(154, 1, "Data Installation and Networking Services Ltd. Register No 2802029");
	
	$margin = 20;
	
	$pdf->addHeading(70, 20 + $margin, "Quotation No:", $header->prefix . sprintf("%04d", $header->headerid));
	$pdf->addHeading(70, 24 + $margin, "Contact:", GetUserName($header->contactid));
	$pdf->addHeading(70, 28 + $margin, "Email:", GetEmail($header->contactid));
	$pdf->addHeading(70, 32 + $margin, "Contact Number:", "01252 375566");
	$pdf->addHeading(70, 36 + $margin, "Date:", $header->createddate);
	$pdf->addHeading(70, 40 + $margin, "Prepared By:", GetUserName($header->createdby));
	$pdf->addHeading(70, 44 + $margin, "Customer Ref:", $header->customer);
	$pdf->addHeading(70, 48 + $margin, "CPID Number:", $header->cpid);
	$pdf->addHeading(70, 52 + $margin, "Cost Code:", $header->costcodedesc);
		
	$cols=array( "Item"    => 13,
	             "Product / Service Description"  => 97,
	             "Qty"     => 20,
	             "Unit"      => 20,
	             "Unit Price"      => 20,
	             "Total" => 20 );
