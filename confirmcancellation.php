...
<div>
	...
	<?php	
		...
		if ($eventApproved) {
			if ($header->status == "X") {
	?>
			<h2>Job <a title="View Job" href="viewquote.php?id=<?php echo $header->headerid; ?>"><?php echo $header->getHeaderID(); ?></a> has been cancelled.</h2>
	...
	?>
			<h2>Job <a title="View Job" href="viewquote.php?id=<?php echo $header->headerid; ?>"><?php echo $header->getHeaderID(); ?></a> has been approved for cancellation.</h2>
	...
	?>
			<h2>Job <a title="View Job" href="viewquote.php?id=<?php echo $header->headerid; ?>"><?php echo $header->getHeaderID(); ?></a> has been rejected for cancellation.</h2>
