<?php
	...
	class QuotationHeader {
	    ...
	    public function getEmailDetails() {
			...
			$email = $email .  "</tr>\n";
			$email = $email .  "<tr>\n";
			$email = $email .  "<td class='label'>ETA for Install</td>\n";
			
			if ($this->requiredbymode == "N") {
				$email = $email . "<td>Non-rack dependant - (up to 5 racks worth - 5 days)</td>\n";
				
			} else if ($this->requiredbymode == "R") {
				$email = $email . "<td>Rack dependant - (up to 5 racks worth - 10 days)</td>\n";
				
			} else {
				$email = $email .  "<td>TBA – Projects/bespoke – (Rack dependant over racks worth - 20 days)</td>\n";
			}
			...
			$email = $email .  "<tr>\n";
			$email = $email .  "<tr>\n";
			$email = $email .  "<td class='label'>CPID Number</td>\n";
			$email = $email .  "<td>" . $this->cpid . "</td>\n";
			$email = $email .  "</tr>\n";
			$email = $email .  "<tr>\n";
	    ...
	    function showHeaderDetails($history = true) {
	    	...
	    	if (($this->status == "P" || $this->status == "X")) { 
				...
				$qry = "SELECT DISTINCT B.roleid, B.status, " .
						...
						"FROM datatech_cancelledjobflowheader A " .
						"INNER JOIN datatech_cancelledjobflowdetail B  " .
						"ON B.flowheaderid = A.id  " .
						"INNER JOIN datatech_userroles C  " .
						"ON C.roleid = B.roleid  " .
						"LEFT OUTER JOIN datatech_members D  " .
			...
			if ($this->status == "N" || $this->status == "R") {
				...
				echo "<td class='data'>" . $this->prefix . sprintf("%04d", $this->headerid);

			} else {
				echo "<td class='label'>Job Number</td>\n";
				echo "<td class='data'>" . $this->jobprefix . sprintf("%04d", $this->headerid);
			}
			...
			echo "<td class='data'>" . GetUserName($this->createdby) . "</td>\n";
			echo "</tr>\n";
			echo "</tr>\n";
			echo "<tr>\n";
			echo "<td class='label'>Status</td>\n";
			echo "<td class='data'>" . $this->getStatus();
			...
			echo "<tr>\n";
			echo "<td class='label'>ETA for Install</td>\n";
			
			if ($this->requiredbymode == "N") {
				echo "<td class='data'>Non-rack dependant - (up to 5 racks worth - 5 days)</td>\n";
				
			} else if ($this->requiredbymode == "R") {
				echo "<td class='data'>Rack dependant - (up to 5 racks worth - 10 days)</td>\n";
				
			} else {
				echo "<td class='data'>TBA – Projects/bespoke – (Rack dependant over racks worth - 20 days)</td>\n";
			}
			echo "</tr>\n";
			
			echo "<tr>\n";
			echo "<td class='label'>Customer</td>\n";
			echo "<td class='data'>" . $this->customer . "</td>\n";
			echo "</tr>\n";
			
			if ($this->ccf != "") {
				echo "<td class='label'>CCF Number</td>\n";
				echo "<td class='data'>" . $this->ccf . "</td>\n";
				echo "</tr>\n";
			}
			
			if ($this->ccfpath != "") {
				echo "<td class='label'>CCF Path</td>\n";
				echo "<td class='data ccfpath'>" . $this->ccfpath . "</td>\n";
				echo "</tr>\n";
			}
			
			if ($this->ccfschedule != "") {
				echo "<td class='label'>CCF Schedule</td>\n";
				echo "<td class='data'>" . $this->ccfschedule . "</td>\n";
				echo "</tr>\n";
			}
			
			if ($this->sungardpo != "") {
				echo "<td class='label'>Sungard PO</td>\n";
				echo "<td class='data'>" . $this->sungardpo . "</td>\n";
				echo "</tr>\n";
			}
			
			if ($this->customerpo != "") {
				echo "<td class='label'>Customer PO</td>\n";
				echo "<td class='data'>" . $this->customerpo . "</td>\n";
				echo "</tr>\n";
			}
			
			echo "<tr>\n";
			echo "<td class='label'>Contact</td>\n";
			echo "<td class='data'>" . GetUserName($this->contactid) . "</td>\n";
			echo "</tr>\n";
			echo "<tr>\n";
			echo "<td class='label'>Site</td>\n";
			echo "<td class='data'>" . GetSiteName($this->siteid) . "</td>\n";
			echo "</tr>\n";
			echo "<tr>\n";
			
			echo "<tr>\n";
			echo "<td class='label'>CPID Number</td>\n";
			echo "<td class='data'>" . $this->cpid . "</td>\n";
			echo "</tr>\n";
			
			if ($this->costcodedesc != "") {
				echo "<tr>\n";
				echo "<td class='label'>Cost Code</td>\n";
				echo "<td class='data'>" . $this->costcodedesc . "</td>\n";
				echo "</tr>\n";
			}
			...
			if ($this->internalapprovalcode != "") {
				...
				echo "<td class='data'>" . $this->internalapprovalcode . "</td>\n";
				echo "</tr>\n";
			}
			
			if ($this->cabinstalldate != "00/00/0000") {
				echo "<tr>\n";
				echo "<td class='label'>CAB Install Date</td>\n";
				echo "<td class='data'>" . $this->cabinstalldate . "</td>\n";
				echo "</tr>\n";
			}
			...
			if ($this->status == "R" || $this->status == "N") {
				...
				echo "<td class='data'>" . $this->createddate . "</td>\n";
				echo "</tr>\n";
			}
			...
			if ($this->status == "A") {
				...
				echo "<td class='data'>" . GetUserName($this->approvedby) . "</td>\n";
				echo "</tr>\n";
				echo "<tr>\n";
				echo "<td class='label'>Verified Date</td>\n";
				echo "<td class='data'>" . $this->approveddate . "</td>\n";
				echo "</tr>\n";
			}
			...
			if ($this->status == "S") {
				...
				echo "<td class='data'>" . GetUserName($this->scheduledby) . "</td>\n";
				echo "</tr>\n";
				echo "<tr>\n";
				echo "<td class='label'>Scheduled Date</td>\n";
				echo "<td class='data'>" . $this->scheduleddate . "</td>\n";
				echo "</tr>\n";
			}
			...
			if ($this->status == "I") {
				...
				echo "<td class='data'>" . GetUserName($this->ceapprovedby) . "</td>\n";
				echo "</tr>\n";
				echo "<tr>\n";
				echo "<td class='label'>CE Approved Date</td>\n";
				echo "<td class='data'>" . $this->ceapproveddate . "</td>\n";
				echo "</tr>\n";
			}
			...
			if ($this->status == "C") {
				...
				echo "<td class='data'>" . GetUserName($this->completedby) . "</td>\n";
				echo "</tr>\n";
				echo "<tr>\n";
				echo "<td class='label'>Completed Date</td>\n";
				echo "<td class='data'>" . $this->completeddate . "</td>\n";
				echo "</tr>\n";
			}
			...
			if ($this->status == "Q") {
				...
				echo "<td class='data'>" . GetUserName($this->qaby) . "</td>\n";
				echo "</tr>\n";
				echo "<tr>\n";
				echo "<td class='label'>QA Date</td>\n";
				echo "<td class='data'>" . $this->qadate . "</td>\n";
				echo "</tr>\n";
			}
			...
			if ($this->status == "V") {
				...
				echo "<td class='data'>" . GetUserName($this->archivedby) . "</td>\n";
				echo "</tr>\n";
				echo "<tr>\n";
				echo "<td class='label'>Handover Date</td>\n";
				echo "<td class='data'>" . $this->archiveddate . "</td>\n";
				echo "</tr>\n";
			}
	    	...
	    	echo "$(document).ready(\n";
			echo "function() {\n";
			echo "$('.headinggroup .ccfpath').each(function(){ $(this).attr('title', $(this).html());  });\n";
			echo "}\n";
			echo ");\n";
	    	echo "</script>";
	    }
		...
		function approve() {
			...
			$qry = "UPDATE datatech_quoteheader SET " .
					"status = 'A', " .
					"notes = '$this->notes', " .
					"approveddate = NOW(), " .
			...
			$result = mysql_query($qry);
		   	...
		   	if (! $result) {
		   		die("Error UPDATE datatech_quoteheader (APPROVE):" . $qry . " - " . mysql_error());
		   	}
			
			$ordervalue = $this->getTotal();

			if ($this->costcode == "CAPEXCCF") {
				$qry = "UPDATE datatech_siteconfig SET currentcapexdealpovalue = currentcapexdealpovalue - $ordervalue";
				$result = mysql_query($qry);
				
			   	if (! $result) {
			   		die("Error UPDATE datatech_siteconfig (APPROVE):" . $qry . " - " . mysql_error());
			   	}
			
				$qry = "SELECT currentcapexdealpovalue, capexdealpovalue, capexdealpovaluethreshold " .
						"FROM datatech_siteconfig";
				$result = mysql_query($qry);
			...
			if ($this->costcode == "CAPEXCCF" ||
				$this->costcode == "CAPEXBESPOKE" ||
				$this->costcode == "OPEXBESPOKE" ||
				$this->costcode == "OPEXCUSTOMERPO" ) {
			...
			} else if ($this->costcode == "OPEXCONSULTANCY") {
			...
			$qry = "INSERT INTO datatech_jobheader (prefix, quoteid) VALUES ('SC-194SG', $this->headerid)";
			$result = mysql_query($qry);
			
		   	if (! $result) {
		   		die("Error INSERT datatech_jobheader (APPROVE):" . $qry . " - " . mysql_error());
		   	}
		...
		public function implementreject() {
			...
			$result = mysql_query($qry);
		   	...
		   	if (! $result) {
		   		die("Error UPDATE datatech_quoteheader (COMPLETE):" . $qry . " - " . mysql_error());
		   	}
		...
		public function schedulereject() {
			$this->notes = dateStampString($this->oldnotes, $this->notes, "SCHEDULE REJECTION NOTES");
			...
			$result = mysql_query($qry);
		   	...
		   	if (! $result) {
		   		die("Error UPDATE datatech_quoteheader (REJECT SCHEDULE):" . $qry . " - " . mysql_error());
		   	}
			...
			sendUserMessage(
					$this->contactid,
					"Scheduling Rejected",
					"<h1>Job " . $this->jobprefix . sprintf("%04d", $this->headerid) . " has been schedule rejected by " . GetUserName() . "</h1>" . $this->getEmailDetails()
				);
		...
		public function deleteThrowAwayQuote() {
			$qry = "DELETE FROM datatech_cancelledquoteitem " .
					"WHERE headerid = $this->headerid";
			$result = mysql_query($qry);
			
		   	if (! $result) {
		   		die("DELETE FROM datatech_cancelledquoteitem:" . $qry . " - " . mysql_error());
		   	}
			
			$qry = "DELETE FROM datatech_cancelledquoteheader " .
					"WHERE id = $this->headerid";
			$result = mysql_query($qry);
			
		   	if (! $result) {
		   		die("DELETE FROM datatech_cancelledquoteheader:" . $qry . " - " . mysql_error());
		   	}
		...
		public function saveThrowAwayNotes() {
			...
			$qry = "UPDATE datatech_cancelledquoteheader SET " .
					"notes = '$this->notes' " .
					"WHERE id = $this->headerid";
			$result = mysql_query($qry);
		}
		...
		public function archive() {
			...
			$result = mysql_query($qry);
		   	...
		   	if (! $result) {
		   		die("Error UPDATE datatech_quoteheader (ARCHIVE):" . $qry . " - " . mysql_error());
		   	}
	    ...
	    public function requestApproval() {
			...
			if($result) {
				while (($member = mysql_fetch_assoc($result))) {
					...
					if ($member['ordervalue'] < 5000) {
						$approvalid = $below1kid;
							
					} else if ($member['ordervalue'] < 50000) {
	    ...
	    public function loadThrowAway($headerid) {
			$qry = "SELECT A.siteid, A.prefix, A.status, A.contactid, A.costcode, A.cpid, A.customer, A.ccf, A.customerpo, " .
					...
					"A.scheduledby, A.completedby, A.archivedby, A.qaby, A.ccfpath, A.sungardpo, A.ccfschedule, " .
					"A.internalapprovalcode, B.id AS jobid, B.prefix AS jobprefix " .
					"FROM datatech_cancelledquoteheader A " .
			...
			$result = mysql_query($qry);
		   	...
		   	if (! $result) {
		   		die("Error SELECT FROM datatech_cancelledquoteheader:" . $qry . " - " . mysql_error());
		   	}
			...
			while (($member = mysql_fetch_assoc($result))) {
			    ...
			    $this->requiredbymode = $member['requiredbymode'];
			    $this->sungardpo = $member['sungardpo'];
			    $this->ccfschedule = $member['ccfschedule'];
			    ...
			    $index = 0;
				$qry = "SELECT * FROM datatech_cancelledquoteitem " .
				...
				if($itemresult) {
					while (($itemmember = mysql_fetch_assoc($itemresult))) {
						...
						$qry = "SELECT A.*, B.name AS fromareaname, C.name AS toareaname " .
								"FROM datatech_cancelledquoteitemlongline A " .
								"INNER JOIN datatech_areas B " .
								"ON B.id = A.fromareaid " .
								"INNER JOIN datatech_areas C " .
								"ON C.id = A.toareaid " .
						...
						$qry = "SELECT A.*, B.name AS fromareaname, C.name AS toareaname " .
								"FROM datatech_cancelledquoteitempanel A " .
								"INNER JOIN datatech_areas B " .
								"ON B.id = A.fromareaid " .
								"INNER JOIN datatech_areas C " .
								"ON C.id = A.toareaid " .
	    ...
	    public function load($headerid) {
			$qry = "SELECT A.siteid, A.prefix, A.status, A.contactid, A.costcode, A.cpid, A.customer, A.ccf, A.customerpo, " .
					...
					"A.scheduledby, A.completedby, A.archivedby, A.qaby, A.ccfpath, A.sungardpo, A.ccfschedule, A.originalstatus, " .
					"A.internalapprovalcode, B.id AS jobid, B.prefix AS jobprefix " .
					"FROM datatech_quoteheader A " .
					"LEFT OUTER JOIN datatech_jobheader B " .
					"ON B.quoteid = A.id " .
			...
			$result = mysql_query($qry);
		   	...
		   	if (! $result) {
		   		die("Error SELECT FROM datatech_quoteheader:" . $qry . " - " . mysql_error());
		   	}
			...
			while (($member = mysql_fetch_assoc($result))) {
				...
				if ($this->costcode == "CAPEXCCF") {
					...
					$this->costcodedesc = "OPEX - Consultancy'";	
				}
			    
			    $index = 0;
				$qry = "SELECT * FROM datatech_quoteitem " .
						"WHERE headerid = $headerid";
				$itemresult = mysql_query($qry);
				...
				if($itemresult) {
					while (($itemmember = mysql_fetch_assoc($itemresult))) {
						...
						$qry = "SELECT A.*, B.name AS fromareaname, C.name AS toareaname " .
								"FROM datatech_quoteitemlongline A " .
								"INNER JOIN datatech_areas B " .
								"ON B.id = A.fromareaid " .
								"INNER JOIN datatech_areas C " .
								"ON C.id = A.toareaid " .
						...
						$qry = "SELECT A.*, B.name AS fromareaname, C.name AS toareaname " .
								"FROM datatech_quoteitempanel A " .
								"INNER JOIN datatech_areas B " .
								"ON B.id = A.fromareaid " .
								"INNER JOIN datatech_areas C " .
								"ON C.id = A.toareaid " .
	    ...
	    private function updateCancellationStatus($status) {
			...
			if($result) {
				while (($member = mysql_fetch_assoc($result))) {
					...
					$qry = "UPDATE datatech_cancelledjobflowdetail SET " .
							"status = '$status', " .
							"processeddate = NOW(), " .
					...
					$itemresult = mysql_query($qry);
				   	...
				   	if (! $itemresult) {
				   		die("Error UPDATE datatech_cancelledjobflowdetail:" . $qry . " - " . mysql_error());
				   	}
				}
				
			} else {
	   			die("Error SELECT FROM datatech_cancelledjobflowheader:" . $qry . " - " . mysql_error());
			}
	    }
	    ...
	    private function confirmCancellation() {
			...
			if (! $found) {
				...
				$result = mysql_query($qry);
			   	...
			   	if (! $result) {
			   		die("Error UPDATE datatech_quoteheader:" . $qry . " - " . mysql_error());
			   	}
				...
				if ($this->costcode == "CAPEXCCF") {
					...
					$result = mysql_query($qry);
				   	...
				   	if (! $result) {
				   		die("Error UPDATE datatech_siteconfig (currentcapexdealpovalue):" . $qry . " - " . mysql_error());
				   	}
				}
	    ...
	    public function recover() {
	    	if ($this->headerid != 0) {
				...
				$result = mysql_query($qry);
			   	...
			   	if (! $result) {
			   		die("Error UPDATE datatech_quoteheader (recover):" . $qry . " - " . mysql_error());
			   	}
	    	}
	    }
	    ...
	    public function cancel($cancelnotes = "") {
	    	if ($this->headerid != 0) {
	    		...
	    		if ($column != "") {
					$qry = "SELECT $column FROM datatech_siteconfig";
					$result = mysql_query($qry);
					$stage = "";
					...
					if($result) {
						while (($member = mysql_fetch_assoc($result))) {
				   		...
				   		die("Error SELECT $column FROM datatech_siteconfig:" . $qry . " - " . mysql_error());
					}
	
					$qry = "INSERT INTO datatech_cancelledjobflowheader (quoteid, routeid) VALUES ($this->headerid, '$stage')";
					$result = mysql_query($qry);
					$flowheaderid = mysql_insert_id();
	
				   	if (! $result) {
				   		die("Error INSERT INTO datatech_cancelledjobflowheader:" . $qry . " - " . mysql_error());
				   	}
					
					$qry = "SELECT roleid " .
							"FROM datatech_roleroutes " .
							"WHERE routeid = '$stage'";
					$result = mysql_query($qry);
					...
					if($result) {
						while (($member = mysql_fetch_assoc($result))) {
							...
							$qry = "INSERT INTO datatech_cancelledjobflowdetail (flowheaderid, roleid, status) VALUES ($flowheaderid, '$role', ' ')";
	    ...
	    public function copy() {
		    ...
		    $quote->ccfschedule = $this->ccfschedule;
		    $quote->ccfpath = $this->ccfpath;
		    $quote->cabinstalldate = $this->cabinstalldate;
		    $quote->requiredbymode = $this->requiredbymode;
	    ...
	    public function saveThrowAway($throwaway = true) {
	    	if ($this->headerid != 0) {
				...
				$this->ccfschedule = mysql_escape_string($this->ccfschedule);
				...
				$qry = "UPDATE datatech_cancelledquoteheader SET " .
						...
						"requiredbymode = '$this->requiredbymode', " .
						"costcode = '$this->costcode', " .
						"cpid = '$this->cpid', " .
						"ccfpath = '$this->ccfpath', " .
						"sungardpo = '$this->sungardpo', " .
						"ccfschedule = '$this->ccfschedule', " .
						"notes = '$this->notes' " .
						"WHERE id = $this->headerid";
				$result = mysql_query($qry);
			   	
			   	if (! $result) {
			   		die("Error UPDATE datatech_cancelledquoteheader:" . $qry . " - " . mysql_error());
			   	}
				...
				for ($i = 0; $i < $this->itemCount(); $i++) {
					...
					if (! $item->deleted) {
						if ($item->id != 0) {
							$qry = "UPDATE datatech_cancelledquoteitem SET " .
							...
							$result = mysql_query($qry);
						   	...
						   	if (! $result) {
						   		die("Error UPDATE datatech_cancelledquoteitem:" . mysql_error());
						   	}
							...
							$qry = "INSERT INTO datatech_cancelledquoteitem  " .
							...
							$linenumber++;
						   	...
						   	if (! $result) {
						   		die("Error INSERT INTO datatech_cancelledquoteitem:" . mysql_error());
						   	}
						...
						$qry = "DELETE FROM datatech_cancelledquoteitemlongline WHERE quoteitemid = $item->id";
						$result = mysql_query($qry);
			   	
					   	if (! $result) {
					   		die("Error DELETE FROM datatech_cancelledquoteitemlongline:" . $qry . " - " . mysql_error());
					   	}
					   	...
					   	if ($item->longline != null) {
							...
							for ($x = 0; $x < $counter; $x++) {
								...
								$qry = "INSERT INTO datatech_cancelledquoteitemlongline " .
								...
								$result = mysql_query($qry);
							   	...
							   	if (! $result) {
							   		die("Error INSERT INTO datatech_cancelledquoteitemlongline:" . mysql_error());
							   	}
							}
					   	}
					   	
						$qry = "DELETE FROM datatech_cancelledquoteitempanel WHERE quoteitemid = $item->id";
						$result = mysql_query($qry);
								
					   	if (! $result) {
					   		die("Error DELETE FROM datatech_cancelledquoteitempanel:" . mysql_error());
					   	}
					   	...
					   	if ($item->panel != null) {
							...
							for ($x = 0; $x < $counter; $x++) {
								...
								$qry = "INSERT INTO datatech_cancelledquoteitempanel " .
								...
								$result = mysql_query($qry);
							   	...
							   	if (! $result) {
							   		die("Error INSERT INTO datatech_cancelledquoteitempanel:" . mysql_error());
							   	}
							}
					   	}
						...
						$result = mysql_query($qry);
					   	...
					   	if (! $result) {
					   		die("Error DELETE FROM datatech_cancelledquoteitemlongline:" . mysql_error());
					   	}
						...
						$qry = "DELETE FROM datatech_cancelledquoteitem WHERE id = $item->id";
						$result = mysql_query($qry);
								
					   	if (! $result) {
					   		die("Error DELETE FROM datatech_cancelledquoteitem:" . mysql_error());
					   	}
					}
				}
				...
				$qry = "INSERT INTO datatech_cancelledquoteheader  " .
						"(prefix, status, siteid, customer, ccf, customerpo, contactid, internalapprovalcode, " .
						"cabinstalldate, ccfpath, sungardpo, ccfschedule, requiredbymode, costcode, cpid, notes, createdby, createddate, throwaway) " .
						"VALUES " .
						"('$prefix', 'N', $this->siteid, '$this->customer', '$this->ccf', '$this->customerpo', $this->contactid, '$this->internalapprovalcode', " .
						"'$mysql_cabinstalldate', '$this->ccfpath', '$this->sungardpo', '$this->ccfschedule', '$this->requiredbymode', '$this->costcode', '$this->cpid', '$this->notes', " . $_SESSION['SESS_MEMBER_ID'] . ", NOW(), '$throwaway')";
				$result = mysql_query($qry);
			   	...
			   	if (! $result) {
			   		die("Error INSERT INTO datatech_cancelledquoteheader:" . $qry . " - " . mysql_error());
			   	}
				...
				for ($i = 0; $i < $this->itemCount(); $i++) {
					...
					if (! $item->deleted) {
						...
						$result = mysql_query($qry);
					   	...
					   	if (! $result) {
					   		die("Error (NEW) INSERT INTO datatech_cancelledquoteitem:" . mysql_error());
					   	}
	    ...
	    public function save() {
	    	...
	    	if ($this->headerid != 0) {
				...
				for ($i = 0; $i < $this->itemCount(); $i++) {
					...
					if (! $item->deleted) {
						if ($item->id != 0) {
							$qry = "UPDATE datatech_quoteitem SET " .
									"description = '$item->productdesc', " .
									"qty = $item->qty, " .
									"cat1 = $item->cat1, " .
									"cat2 = $item->cat2, " .
							...
							$result = mysql_query($qry);
						   	...
						   	if (! $result) {
						   		die("Error UPDATE datatech_quoteitem:" . mysql_error());
						   	}
							...
							$linenumber++;
						   	...
						   	if (! $result) {
						   		die("Error INSERT INTO datatech_quoteitem:" . mysql_error());
						   	}
						...
						$qry = "DELETE FROM datatech_quoteitemlongline WHERE quoteitemid = $item->id";
						$result = mysql_query($qry);
			   	
					   	if (! $result) {
					   		die("Error DELETE FROM datatech_quoteitemlongline:" . $qry . " - " . mysql_error());
					   	}
					   	...
					   	if ($item->longline != null) {
							...
							for ($x = 0; $x < $counter; $x++) {
								...
								$qry = "INSERT INTO datatech_quoteitemlongline " .
										"(quoteitemid, fromareaid, fromcabinet, toareaid, tocabinet, notes, createdby, createddate) " .
										"VALUES " .
										"($item->id, " .
										"" . $item->longline->item[$x]->fromarea . ", " .
								...
								$result = mysql_query($qry);
							   	...
							   	if (! $result) {
							   		die("Error INSERT INTO datatech_quoteitemlongline:" . mysql_error() . " - " . $qry);
							   	}
							}
					   	}
					   	
						$qry = "DELETE FROM datatech_quoteitempanel WHERE quoteitemid = $item->id";
						$result = mysql_query($qry);
								
					   	if (! $result) {
					   		die("Error DELETE FROM datatech_quoteitempanel:" . mysql_error());
					   	}
					   	...
					   	if ($item->panel != null) {
							...
							for ($x = 0; $x < $counter; $x++) {
								...
								$qry = "INSERT INTO datatech_quoteitempanel " .
										"(quoteitemid, fromareaid, fromcabinet, fromposition, fromlocation, fromuloc, " .
										"toareaid, tocabinet, toposition, tolocation, touloc, createdby, createddate) " .
										"VALUES " .
										"($item->id, " .
								...
								$result = mysql_query($qry);
							   	...
							   	if (! $result) {
							   		die("Error INSERT INTO datatech_quoteitempanel:" . mysql_error());
							   	}
							}
					   	}
						...
						$result = mysql_query($qry);
					   	...
					   	if (! $result) {
					   		die("Error DELETE FROM datatech_quoteitemlongline:" . mysql_error());
					   	}
						...
						$qry = "DELETE FROM datatech_quoteitem WHERE id = $item->id";
						$result = mysql_query($qry);
								
					   	if (! $result) {
					   		die("Error DELETE FROM datatech_quoteitem:" . mysql_error());
					   	}
					}
				}
	    		...
	    		$updated = false;
				$prefix = "SQ-194SG";
	    		$mysql_cabinstalldate = date("Y-m-d");
				...
				$qry = "INSERT INTO datatech_quoteheader  " .
						"(prefix, status, siteid, customer, ccf, customerpo, contactid, internalapprovalcode, " .
						"cabinstalldate, ccfpath, sungardpo, ccfschedule, requiredbymode, costcode, cpid, notes, createdby, createddate) " .
						"VALUES " .
						"('$prefix', 'N', $this->siteid, '$this->customer', '$this->ccf', '$this->customerpo', $this->contactid, '$this->internalapprovalcode', " .
						"'$mysql_cabinstalldate', '$this->ccfpath', '$this->sungardpo', '$this->ccfschedule', '$this->requiredbymode', '$this->costcode', '$this->cpid', '$this->notes', " . $_SESSION['SESS_MEMBER_ID'] . ", NOW())";
				$result = mysql_query($qry);
			   	$this->headerid =  mysql_insert_id();
			   	$this->createdby = $_SESSION['SESS_MEMBER_ID'];
			   	$this->createddate = date("d/m/Y");
			   	...
			   	if (! $result) {
			   		die("Error INSERT INTO datatech_quoteheader:" . $qry . " - " . mysql_error());
			   	}
				
				$qry = "UPDATE datatech_documents SET " .
				...
				$result = mysql_query($qry);
			   	...
			   	if (! $result) {
			   		die("Error UPDATE datatech_documents:" . $qry . " - " . mysql_error());
			   	}
				...
				for ($i = 0; $i < $this->itemCount(); $i++) {
					...
					if (! $item->deleted) {
						...
						$result = mysql_query($qry);
					   	...
					   	if (! $result) {
					   		die("Error (NEW) INSERT INTO datatech_quoteitem:" . mysql_error());
					   	}
					   	...
					   	if ($item->longline != null) {
							...
							for ($x = 0; $x < $counter; $x++) {
								...
								$result = mysql_query($qry);
							   	...
							   	if (! $result) {
							   		die("Error INSERT INTO datatech_quoteitemlongline:" . mysql_error());
							   	}
							}
					   	}
