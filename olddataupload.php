		        ...
		        if ($data[7] != "") {
			        ...
			        if (startsWith($data[3], "Price")) {
				        ...
				        for ($c=2; $c < $num; $c++) {
							...
							$qry = "INSERT INTO datatech_categories (name, parentcategoryid, createdby, createddate) VALUES ('$subcat1', $categoryid, " . $_SESSION['SESS_MEMBER_ID'] . ", NOW())";
							$result = mysql_query($qry);
							...
							$qry = "INSERT INTO datatech_categories (name, parentcategoryid, createdby, createddate) VALUES ('$subcat2', $subcat1id, " . $_SESSION['SESS_MEMBER_ID'] . ", NOW())";
							$result = mysql_query($qry);
							...
							$qry = "INSERT INTO datatech_products (name, categoryid, createdby, createddate) VALUES ('$productname', $subcat2id, " . $_SESSION['SESS_MEMBER_ID'] . ", NOW())";
							$result = mysql_query($qry);
