<?php 
	...
	createDocumentLink();
?>
<form class="contentform" method="post" action="savenewquoteheader.php" onsubmit="return validate()">
	<div class="buttonContainer">
		...
		?>
				<input type="button" class="navButton" value="DOCUMENTS" onclick="viewSessionDocument('<?php echo session_id(); ?>')"></input>
		<?php
			}
		?>
