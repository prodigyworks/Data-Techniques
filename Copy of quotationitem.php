<?php
	...
	class QuotationHeader {
	    ...
	    public function getEmailDetails() {
			...
			$email = $email .  "<tr>\n";
			$email = $email .  "<td class='label'>Sungard PO</td>\n";
			$email = $email .  "<td>" . $this->sungardpo . "</td>\n";
			$email = $email .  "</tr>\n";
	    ...
	    public function saveThrowAway($throwaway = true) {
	    	if ($this->headerid != 0) {
				...
				$qry = "INSERT INTO datatech_cancelledquoteheader  " .
						...
						"cabinstalldate, ccfpath, sungardpo, ccfschedule, requiredbymode, costcode, notes, createdby, createddate, throwaway) " .
						"VALUES " .
						"('$prefix', 'N', $this->siteid, '$this->customer', '$this->ccf', '$this->customerpo', $this->contactid, '$this->internalapprovalcode', " .
						"'$mysql_cabinstalldate', '$this->ccfpath', '$this->sungardpo', '$this->ccfschedule', '$this->requiredbymode', '$this->costcode', '$this->notes', " . $_SESSION['SESS_MEMBER_ID'] . ", NOW(), '$throwaway')";
				$result = mysql_query($qry);
	    ...
	    public function save() {
	    	...
	    	if ($this->headerid != 0) {
				...
				$qry = "INSERT INTO datatech_quoteheader  " .
						"(prefix, status, siteid, customer, ccf, customerpo, contactid, internalapprovalcode, " .
						"cabinstalldate, ccfpath, sungardpo, ccfschedule, requiredbymode, costcode, notes, createdby, createddate) " .
						"VALUES " .
						"('$prefix', 'N', $this->siteid, '$this->customer', '$this->ccf', '$this->customerpo', $this->contactid, '$this->internalapprovalcode', " .
						"'$mysql_cabinstalldate', '$this->ccfpath', '$this->sungardpo', '$this->ccfschedule', '$this->requiredbymode', '$this->costcode', '$this->notes', " . $_SESSION['SESS_MEMBER_ID'] . ", NOW())";
				$result = mysql_query($qry);
			   	$this->headerid =  mysql_insert_id();
			   	$this->createdby = $_SESSION['SESS_MEMBER_ID'];
			   	$this->createddate = date("d/m/Y");
